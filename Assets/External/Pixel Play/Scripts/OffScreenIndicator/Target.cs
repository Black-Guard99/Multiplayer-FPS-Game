...
public class Target : MonoBehaviour
{
    ...
    /// </summary>
    public void SetOffscreenIndicator(OffScreenIndicator indicator){
        offScreenIndicator = indicator;
    ...
    /// </summary>
    public void OnObjectDissappear(){
        offScreenIndicator.TargetStateChanged?.Invoke(this, false);

    }
    private void OnDisable()
    {
        /* if(OffScreenIndicator.current.TargetStateChanged != null)
        {
        } */
    }
