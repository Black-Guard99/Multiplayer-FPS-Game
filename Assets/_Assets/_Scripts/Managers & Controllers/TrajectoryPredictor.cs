...
public class TrajectoryPredictor : MonoBehaviour {
    ...
    [SerializeField, Range(0.01f, 0.5f), Tooltip("The time increment used to calculate the trajectory")] private float increment = 0.025f;
    ...
    [SerializeField] private LayerMask throwingLayer;

    [SerializeField,Range(0.025f,1f)] private float offset = 0.025f;// Offset marker from surface
    ...
    public void PredictTrajectory(ProjectileProperties projectile) {
        ...
        for (int i = 1; i < maxPoints; i++) {
            ...
            if (Physics.Raycast(position, velocity.normalized, out RaycastHit hit, overlap,throwingLayer)) {
    ...
    private void MoveHitMarker(RaycastHit hit) {
        ...
        hitMarker.rotation = Quaternion.FromToRotation(Vector3.back,hit.normal);
    }
